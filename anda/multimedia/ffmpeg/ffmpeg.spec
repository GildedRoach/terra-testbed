...
%global pkg_suffix %{!?with_all_codecs:-free}%{?with_all_codecs:%{nil}}
...
%bcond chromaprint %{without boostrap}
%bcond flite 1
%endif
...
Patch3:         https://code.ffmpeg.org/FFmpeg/FFmpeg/pulls/20329.patch

# HandBrake patches
Patch5:         ffmpeg-svt-vp9.patch
Patch6:         ffmpeg-HandBrake.patch

# Backport fix for CVE-2025-22921
Patch7:         https://git.ffmpeg.org/gitweb/ffmpeg.git/patch/7f9c7f9849a2155224711f0ff57ecdac6e4bfb57#/ffmpeg-CVE-2025-22921.patch
...
# Even though FDK itself may be redistributable.
# See: https://ffmpeg.org/doxygen/4.4/md_LICENSE.html
# DO NOT change this to pkgconfig(fdk-aac).
...
%endif
# Prevent build from pulling full FDK-AAC builds.
# WARNING: This MUST be ensured otherwise the binary is NOT REDISTRIBUTABLE.
# Even though FDK itself may be redistributable.
# See: https://ffmpeg.org/doxygen/4.4/md_LICENSE.html
# DO NOT remove this.
BuildConflicts: fdk-aac-devel
...
%changelog
* Sun May 31 2026 Gilver E. <roachy@fyralabs.com> - 1:7.1.4-1
